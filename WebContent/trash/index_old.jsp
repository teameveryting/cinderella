...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
 <% if (session == null || session.getAttribute("userInfo") == null || (String) ((ETModel)session.getAttribute("userInfo")).get("userName") == null) {
...
<html class="no-js" ng-app="cynderella">
  <head>
    ...
    <meta name="author" content="">
    	...
    	<link rel="stylesheet" href="lib/css/dataTables.responsive.css">
       ...
       <link rel="stylesheet" href="lib/css/semantic.min.css">
	    ...
	    <script src="lib/js/angular-datatable/angular-datatables.js"></script>
	    <script src="lib/js/angular-datatable/angular-datatables.util.js"></script>
	    <script src="lib/js/angular-datatable/angular-datatables.options.js"></script>
	    <script src="lib/js/angular-datatable/angular-datatables.factory.js"></script>
	    <script src="lib/js/angular-datatable/angular-datatables.renderer.js"></script>
	    <script src="lib/js/angular-datatable/angular-datatables.bootstrap.options.js"></script>
	    <script src="lib/js/angular-datatable/angular-datatables.bootstrap.js"></script>
	    <script src="lib/js/angular-datatable/angular-datatables.directive.js"></script>
